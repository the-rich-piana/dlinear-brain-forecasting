...
class Model(nn.Module):
    """
    Adapter wrapper to integrate POCO with the existing DLinear framework.
    Maps standard framework interface to POCO's interface.
    """
    def __init__(self, configs):
        ...
        # Initialize POCO model
        self.poco = POCO(poco_config, input_size)
    ...
    def forward(self, x_enc, x_mark_enc, x_dec, x_mark_dec,
        ...
        POCO interface: expects list of [L, B, D] tensors
        """
        # x_enc shape: [B, seq_len, D]
        batch_size, seq_len, num_features = x_enc.shape
        
        # Reshape for POCO: [B, L, D] -> [L, B, D]
