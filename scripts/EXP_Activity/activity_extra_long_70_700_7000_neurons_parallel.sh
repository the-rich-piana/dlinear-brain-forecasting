#  sh scripts/EXP_Activity/activity_extra_long_70_700_7000_neurons_parallel.sh
...
experiment_names=("ActivityExtraLong70N" "ActivityExtraLong700N" "ActivityExtraLong7000N")
