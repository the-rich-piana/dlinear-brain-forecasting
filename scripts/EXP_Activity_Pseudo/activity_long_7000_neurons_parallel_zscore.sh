#  sh scripts/EXP_Activity_Pseudo/activity_long_7000_neurons_parallel_zscore.sh
...
experiment_name="ActivityLong7000NZscore"
data_path="session_5ea6bb9b-6163-4e8a-816b-efe7002666b0_7000_zscore.h5"
neuron_count=7000
enc_in=$neuron_count
c_out=$neuron_count
