...
datasets = {
    'Active Task': pd.read_csv("/cs/student/msc/aibh/2024/gcosta/DLinear/ActivityLongActive11392N.csv"),
    'Passive Task': pd.read_csv("/cs/student/msc/aibh/2024/gcosta/DLinear/ActivityLongPassive11392N.csv")
}

# Models to plot (exclude Mean, include Naive reference)
models_to_plot = ['DLinear', 'Linear', 'POCO', 'TSMixer', 'Informer', 'Transformer']
dataset_labels = ['Active Task', 'Passive Task']

# Create 1x2 subplot grid for comparison
...
for i, (dataset_name, data) in enumerate(datasets.items()):
    ...
    ax.set_title(f'{dataset_name}', fontsize=14, fontweight='medium', pad=15, color="black")
...
plt.savefig('/cs/student/msc/aibh/2024/gcosta/DLinear/Experiment_Results/figures/prediction_score_comparison_behavioral.jpeg', 
...
# Export to CSV
csv_file = '/cs/student/msc/aibh/2024/gcosta/DLinear/Experiment_Results/Exp_2/grand_average_results_behavioral.csv'
results_df.to_csv(csv_file, index=False)
print("Saving .csv")

# Generate LaTeX table
tex_file = '/cs/student/msc/aibh/2024/gcosta/DLinear/Experiment_Results/Exp_2/grand_average_results_behavioral.tex'

latex_content = []
latex_content.append("\\begin{table}[h!]")
latex_content.append("\\centering")
latex_content.append("\\caption{Prediction Score Comparison: Active Task vs Passive Task}")
